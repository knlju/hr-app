...
const Alert = ({ type, text }) => {
	return (
		<>
			<div className={`alert alert-${type} fixed bottom-20 right-20 z-4 text-sm rounded-md shadow-lg text-white px-4 py-3 w-64 flex items-center justify-start gap-4`}>
				<div>
