			...
			<div className="flex gap-2 items-center" onClick={handleToggle}>
				...
				<div className={`relative rounded-full w-8 h-4 transition duration-200 ease-linear ${toggle === true ? "bg-orange-600" : "bg-gray-400"}`}>
					<label htmlFor="toggle"
						className={`absolute left-0 bg-white border-2 mb-2 w-4 h-4 rounded-full transition transform duration-100 ease-linear cursor-pointer ${toggle === true ? "translate-x-full border-orange-600" : "translate-x-0 border-gray-400"}`}></label>
